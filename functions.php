...
if (! defined('LAWFIRMPRO_VERSION')) {
	 ...
	 */
	define('LAWFIRMPRO_VERSION', 'thynxo');
}
...
if (! function_exists('lawfirmpro_setup')) :
	...
	function lawfirmpro_setup()
	{
		...
		register_nav_menus(
			array(
				'navigation'    => __('Primary', 'lawfirmpro'),
				'Footer Menu'   => __('Footer Menu', 'lawfirmpro'),
			)
		);
...
function lawfirmpro_cf7_form()
{
	...
	if (class_exists('WPCF7')) {
		...
		if (!empty($posts)) {
			$output .= do_shortcode('[contact-form-7 id="' . esc_attr($posts[0]->ID) . '"]');
		}
	}
...
require_once get_template_directory() . '/inc/cpt-data-import.php';