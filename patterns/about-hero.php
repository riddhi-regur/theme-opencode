...
<!-- wp:group {"className":"stack-overflow","layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
<div class="wp-block-group stack-overflow"><!-- wp:heading {"align":"wide","className":"paragraph-padding","style":{"typography":{"textAlign":"center"}}} -->
<h2 class="wp-block-heading has-text-align-center alignwide paragraph-padding"><?php echo esc_html(lawfirmpro_get_heading('heading_about_hero', 'Legal Excellence Built on Trust and Experience')); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"wide","className":"paragraph-padding","style":{"elements":{"link":{"color":{"text":"var:preset|color|accent"}}}},"textColor":"accent"} -->
<p class="alignwide paragraph-padding has-accent-color has-text-color has-link-color"><?php echo esc_html(lawfirmpro_get_text('text_about_hero', 'For over 25 years, we\'ve provided trusted legal advice to individuals, families, and businesses across England & Wales with expertise, integrity, and practical solutions.')); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:image {"sizeSlug":"large","linkDestination":"none","align":"full","className":"about-main-img"} -->
<figure class="wp-block-image alignfull size-large about-main-img"><img src="<?php echo esc_url(get_theme_file_uri('assets/images/About-Hero.png')); ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->