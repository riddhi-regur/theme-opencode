...
<div class="wp-block-group practice-areas-main"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
    ...
    <!-- wp:group {"className":"practice-area-heading-group","style":{"spacing":{"blockGap":"21px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center","verticalAlignment":"center"}} -->
    <div class="wp-block-group practice-area-heading-group">        <!-- wp:heading {"textAlign":"center","className":"practice-areas-heading","style":{"typography":{"fontWeight":"800","lineHeight":"1.1","fontSize":"56px"},"spacing":{"padding":{"right":"20px","left":"20px"}}}} -->
        <h2 class="wp-block-heading practice-areas-heading" style="padding-right:20px;padding-left:20px;font-size:56px;font-weight:800;line-height:1.1"><?php echo esc_html(lawfirmpro_get_heading('heading_practice', 'Expert Legal Services You Can Trust')); ?></h2>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"className":"practice-areas-paragraph","style":{"typography":{"fontWeight":"500","lineHeight":"1.5","textAlign":"center"},"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"padding":{"right":"20px","left":"20px"}}},"fontFamily":"plus-jakarta-sans"} -->
        <p class="has-text-align-center practice-areas-paragraph has-plus-jakarta-sans-font-family" style="padding-right:20px;padding-left:20px;font-weight:500;line-height:1.5">From family law and criminal defence to employment and property matters, our experienced solicitors provide practical legal advice and dedicated representation tailored to your needs.</p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->

    <!-- wp:group {"className":"custom-posts-grid practice-area-posts-grid","style":{"spacing":{"margin":{"top":"48px","bottom":"48px"},"padding":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0","left":"var:preset|spacing|0","right":"var:preset|spacing|0"}}},"layout":{"type":"default"}} -->
    <div class="wp-block-group custom-posts-grid practice-area-posts-grid" style="margin-top:48px;margin-bottom:48px;padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0)"><!-- wp:query {"queryId":78,"query":{"perPage":9,"pages":0,"offset":0,"postType":"practice-area","order":"asc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[],"format":[]},"metadata":{"categories":["posts"],"patternName":"core/query-grid-posts","name":"Grid"}} -->
        <div class="wp-block-query"><!-- wp:post-template {"style":{"spacing":{"blockGap":"21px"}},"layout":{"type":"grid","columnCount":3}} -->
            ...
            <div class="wp-block-group practice-area-posts-group" style="margin-bottom:80px"><!-- wp:post-featured-image {"height":"430px","className":"practice-areas-post-image"} /-->
                ...
                <div class="wp-block-group practice-area-data-group"><!-- wp:post-title {"textAlign":"left","isLink":true,"className":"practice-areas-post-tile","style":{"typography":{"fontStyle":"normal","fontWeight":"700","letterSpacing":"0%","lineHeight":"1.3","fontSize":"32px"}},"fontFamily":"plus-jakarta-sans"} /-->
                    ...
                    <!-- wp:post-excerpt {"textAlign":"left","showMoreOnNewLine":false,"excerptLength":46,"className":"practice-areas-post-paragraph","style":{"elements":{"link":{"color":{"text":"var:preset|color|accent"}}},"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"400","letterSpacing":"0%","lineHeight":"1.5"},"spacing":{"padding":{"right":"10px"}}},"textColor":"accent","fontFamily":"plus-jakarta-sans"} /-->
                    ...
                    <p class="button-link has-plus-jakarta-sans-font-family" style="padding-top:16px;font-size:16px;font-style:normal;font-weight:800;text-transform:uppercase">View Service →</p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            </div>
    ...
    <div class="wp-block-buttons" style="margin-top:60px"><!-- wp:button {"backgroundColor":"secondary","textColor":"primary","className":"is-style-outline","style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"800","textTransform":"uppercase"},"spacing":{"padding":{"left":"35px","right":"35px","top":"14px","bottom":"14px"}}},"fontFamily":"plus-jakarta-sans"} -->
        ...
        <div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-plus-jakarta-sans-font-family has-custom-font-size wp-element-button" href="<?php echo esc_url(lawfirmpro_get_page_url('contact_page_id', '/contact/')); ?>" style="padding-right:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--lg);font-size:16px;font-style:normal;font-weight:800;text-transform:uppercase">request a quote →</a></div>
        <!-- /wp:button -->
    </div>
    <!-- /wp:buttons -->
</div>
