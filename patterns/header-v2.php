...
<header class="wp-block-group has-secondary-background-color has-background"><!-- wp:group {"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between","verticalAlignment":"center","orientation":"horizontal"}} -->
<div class="wp-block-group has-primary-color has-text-color has-link-color"><!-- wp:site-logo {"width":178,"className":"header-logo","style":{"color":{"duotone":"var:preset|duotone|midnight-glow"}}} /-->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(get_theme_file_uri('assets/images/call-header-1.png')); ?>" alt="" class="wp-image-117"/></figure>
<!-- /wp:image -->
