 ...
 */
?>
<!-- wp:cover {"url":"<?php echo esc_url(get_theme_file_uri('assets/images/hero-v2.png')); ?>","dimRatio":0,"customOverlayColor":"#2e2922","isUserOverlayColor":false,"minHeight":717,"minHeightUnit":"px","contentPosition":"center center","sizeSlug":"full","className":"hero-v2-cover","style":{"spacing":{"padding":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0","left":"var:preset|spacing|0","right":"var:preset|spacing|0"},"margin":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover hero-v2-cover" style="margin-top:var(--wp--preset--spacing--0);margin-bottom:var(--wp--preset--spacing--0);padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0);min-height:717px"><img class="wp-block-cover__image-background size-full" alt="" src="<?php echo esc_url(get_theme_file_uri('assets/images/hero-v2.png')); ?>" data-object-fit="cover" /><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#2e2922"></span>
    <div class="wp-block-cover__inner-container"><!-- wp:group {"className":"hero-content-stack-v2","layout":{"type":"flex","orientation":"vertical","verticalAlignment":"center","justifyContent":"center"}} -->
        <div class="wp-block-group hero-content-stack-v2"><!-- wp:heading {"level":1,"className":"wp-block-heading","style":{"typography":{"textAlign":"center"}},"textColor":"secondary"} -->
            <h1 class="wp-block-heading has-text-align-center has-secondary-color has-text-color"><?php echo esc_html(lawfirmpro_get_heading('heading_hero_v1', 'Trusted Legal Advice When You Need It Most')); ?></h1>
            <!-- /wp:heading -->
