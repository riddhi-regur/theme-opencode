 ...
 */
?>
<!-- wp:cover {"url":"<?php echo esc_url(get_theme_file_uri('assets/images/hero-v2.png')); ?>","dimRatio":0,"customOverlayColor":"#312c2b","isUserOverlayColor":false,"minHeight":500,"minHeightUnit":"px","contentPosition":"top center","sizeSlug":"full","layout":{"type":"constrained"}} -->
<div class="wp-block-cover has-custom-content-position is-position-top-center" style="min-height:500px"><img class="wp-block-cover__image-background wp-image-479 size-full" alt="" src="<?php echo esc_url(get_theme_file_uri('assets/images/hero-v2.png')); ?>" data-object-fit="cover" /><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#312c2b"></span>
