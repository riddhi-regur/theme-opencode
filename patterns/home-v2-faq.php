 ...
 */
?>
<!-- wp:group {"className":"homepage-v2-faq-main","style":{"spacing":{"margin":{"top":"var:preset|spacing|xl","bottom":"var:preset|spacing|xl"}}},"layout":{"type":"constrained","justifyContent":"center"}} -->
<div class="wp-block-group homepage-v2-faq-main" style="margin-top:var(--wp--preset--spacing--xl);margin-bottom:var(--wp--preset--spacing--xl)"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
