...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-accent-7-color has-text-color has-link-color has-border-color has-plus-jakarta-sans-font-family has-text-align-center has-custom-font-size wp-element-button" style="border-color:#afafaf;border-width:1px;border-top-left-radius:300px;border-top-right-radius:300px;border-bottom-left-radius:300px;border-bottom-right-radius:300px;padding-top:var(--wp--preset--spacing--xs);padding-right:24px;padding-bottom:var(--wp--preset--spacing--xs);padding-left:24px;font-size:16px;font-style:normal;font-weight:600;letter-spacing:0%;line-height:1.5"><?php echo esc_html(lawfirmpro_get_label('label_faqs', 'FAQs')); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->

<!-- wp:heading {"className":"stack-overflow","style":{"typography":{"lineHeight":"1.1","textAlign":"center"},"spacing":{"padding":{"bottom":"20px"}}}} -->
<h2 class="wp-block-heading has-text-align-center stack-overflow" style="padding-bottom:20px;line-height:1.1"><?php echo esc_html(lawfirmpro_get_heading('heading_faq', 'Frequently Asked Questions')); ?></h2>
<!-- /wp:heading -->

<!-- wp:group {"className":"homepage-v2-faq-maingroup","layout":{"type":"constrained"}} -->
<div class="wp-block-group homepage-v2-faq-maingroup"><!-- wp:query {"queryId":64,"query":{"perPage":10,"pages":0,"offset":0,"postType":"faq","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[],"format":[]},"metadata":{"categories":["posts"],"patternName":"core/query-standard-posts","name":"Standard"}} -->
...
<!-- wp:post-excerpt {"showMoreOnNewLine":false,"className":"faq-content stack-overflow","style":{"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"400"},"elements":{"link":{"color":{"text":"var:preset|color|accent-10"}}}},"textColor":"accent-10","fontFamily":"plus-jakarta-sans"} /--></div>
<!-- /wp:group -->
