 ...
 */
?>
<!-- wp:group {"className":"section-spacing-legal-challenges","style":{"spacing":{"blockGap":"10px","margin":{"top":"var:preset|spacing|3xl"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group section-spacing-legal-challenges" style="margin-top:var(--wp--preset--spacing--3-xl)"><!-- wp:buttons {"metadata":{"blockVisibility":{"viewport":{"desktop":false,"tablet":false,"mobile":false}}},"layout":{"type":"flex","justifyContent":"center"}} -->
    ...
    <div class="wp-block-group offer-heading-group"><!-- wp:heading {"className":"offers-heading","style":{"spacing":{"padding":{"right":"20px","left":"20px"}},"typography":{"textAlign":"center"}}} -->
        ...
        <!-- wp:paragraph {"className":"has-text-align-center offers-paragraph has-accent-color has-text-color has-link-color","style":{"typography":{"textAlign":"center"},"layout":{"selfStretch":"fit","flexSize":null},"elements":{"link":{"color":{"text":"var:preset|color|accent"}}},"spacing":{"padding":{"right":"20px","left":"20px"}}},"textColor":"accent"} -->
        <p class="has-text-align-center offers-paragraph has-accent-color has-text-color has-link-color" style="padding-right:20px;padding-left:20px"><?php echo esc_html(lawfirmpro_get_text('text_offers_sub', 'How we can help you with your legal needs.')); ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-buttons offer-btn"><!-- wp:button {"className":"transparent-text-black is-style-fill","style":{"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"800","lineHeight":"1","letterSpacing":"0px","textTransform":"uppercase"},"spacing":{"padding":{"top":"var:preset|spacing|sm","bottom":"var:preset|spacing|sm"}}},"fontFamily":"plus-jakarta-sans"} -->
        <div class="wp-block-button transparent-text-black is-style-fill"><a class="wp-block-button__link has-plus-jakarta-sans-font-family has-custom-font-size wp-element-button" href="<?php echo esc_url(lawfirmpro_get_page_url('contact_page_id', '/contact/')); ?>" style="padding-top:var(--wp--preset--spacing--sm);padding-bottom:var(--wp--preset--spacing--sm);font-size:16px;font-style:normal;font-weight:800;letter-spacing:0px;line-height:1;text-transform:uppercase"><?php echo esc_html(lawfirmpro_get_label('btn_request_quote', 'Request a Quote')); ?> ➔</a></div>
        <!-- /wp:button -->
    </div>
    <!-- /wp:buttons -->
</div>
