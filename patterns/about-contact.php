 ...
 */
?>
<!-- wp:cover {"url":"<?php echo esc_url(get_theme_file_uri('assets/images/about-contact.png')); ?>","dimRatio":40,"isUserOverlayColor":true,"sizeSlug":"large","layout":{"type":"constrained"}} -->
<div class="wp-block-cover"><img class="wp-block-cover__image-background size-large" alt="" src="<?php echo esc_url(get_theme_file_uri('assets/images/about-contact.png')); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-40 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
<div class="wp-block-group"><!-- wp:heading {"align":"wide","className":"paragraph-padding","style":{"typography":{"textAlign":"center"}}} -->
<h2 class="wp-block-heading has-text-align-center alignwide paragraph-padding"><?php echo esc_html(lawfirmpro_get_heading('heading_about_contact', 'Speak to an Experienced Solicitor Today')); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"wide","className":"paragraph-padding","style":{"typography":{"textAlign":"center"}}} -->
<p class="has-text-align-center alignwide paragraph-padding"><?php echo esc_html(lawfirmpro_get_text('text_about_contact', 'Whether you need immediate legal advice or want to discuss your options, our friendly team is here to help.')); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full has-custom-css"><img src="<?php echo esc_url(get_theme_file_uri('assets/images/call-header-1.png')); ?>" alt=""/></figure>
<!-- /wp:image -->
...
<p class="has-plus-jakarta-sans-font-family" style="margin-top:var(--wp--preset--spacing--0);margin-bottom:var(--wp--preset--spacing--0);padding-top:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);font-size:12px;font-style:normal;font-weight:500;letter-spacing:0%;line-height:0">Call us today</p>
<!-- /wp:paragraph -->
