...
<div class="wp-block-cover has-custom-content-position is-position-top-center hero-cover" style="margin-top:var(--wp--preset--spacing--0);margin-bottom:var(--wp--preset--spacing--0);padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0);min-height:500px"><img class="wp-block-cover__image-background wp-image-34 size-full" alt="" src="<?php echo esc_url(get_theme_file_uri('assets/images/background.png')); ?>" data-object-fit="cover" /><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#2e2922"></span>
