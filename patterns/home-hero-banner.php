    ...
    <div class="wp-block-cover__inner-container"><!-- wp:columns -->
        <div class="wp-block-columns"><!-- wp:column -->
            <div class="wp-block-column"><!-- wp:group {"className":"hero-content-stack","style":{"spacing":{"padding":{"top":"80px","right":"20px"}}},"layout":{"type":"flex","orientation":"vertical","verticalAlignment":"center"}} -->
                <div class="wp-block-group hero-content-stack" style="padding-top:80px;padding-right:20px"><!-- wp:heading {"level":1,"className":"wp-block-heading hero-content-heading","style":{"typography":{"textAlign":"left"}},"textColor":"secondary"} -->
