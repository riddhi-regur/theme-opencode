 ...
 */
?>
<!-- wp:group {"className":"section-spacing-bottom","style":{"spacing":{"blockGap":"10px","padding":{"top":"var:preset|spacing|lg"}},"border":{"top":{"color":"var:preset|color|accent-8","width":"1px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group section-spacing-bottom" style="border-top-color:var(--wp--preset--color--accent-8);border-top-width:1px;padding-top:var(--wp--preset--spacing--lg)"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
...
<h2 class="wp-block-heading has-text-align-center paragraph-padding"><?php echo esc_html(lawfirmpro_get_heading('heading_contact_hero', 'Speak With Our Legal Experts')); ?></h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full is-resized contact-details-icon"><img src="<?php echo esc_url(get_theme_file_uri('assets/images/Group-9.png')); ?>" alt="" style="object-fit:cover;width:28px;height:38px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full is-resized contact-details-icon"><img src="<?php echo esc_url(get_theme_file_uri('assets/images/Vector.png')); ?>" alt="" style="object-fit:cover;width:36px;height:36px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full is-resized contact-details-icon"><img src="<?php echo esc_url(get_theme_file_uri('assets/images/Group-2084.png')); ?>" alt="" style="object-fit:cover;width:38px;height:38px"/></figure>
<!-- /wp:image -->
