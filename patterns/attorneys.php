...
<div class="wp-block-group attorneys-main"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
    ...
    <div class="wp-block-group attorney-heading-group"><!-- wp:heading {"className":"attorneys-heading","style":{"typography":{"fontWeight":"800","lineHeight":"1.1","fontSize":"clamp(32px, 5vw, 56px)"},"spacing":{"padding":{"right":"var:preset|spacing|sm","left":"var:preset|spacing|sm"}}}} -->
        <h2 class="wp-block-heading attorneys-heading" style="padding-right:var(--wp--preset--spacing--sm);padding-left:var(--wp--preset--spacing--sm);font-size:clamp(32px, 5vw, 56px);font-weight:800;line-height:1.1"><?php echo esc_html(lawfirmpro_get_heading('heading_attorneys', 'Meet Our Experienced Attorneys')); ?></h2>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"className":"attorneys-paragraph","style":{"typography":{"fontWeight":"500","lineHeight":"1.5","textAlign":"center"},"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"padding":{"right":"var:preset|spacing|sm","left":"var:preset|spacing|sm"}}},"fontFamily":"plus-jakarta-sans"} -->
        <p class="has-text-align-center attorneys-paragraph has-plus-jakarta-sans-font-family" style="padding-right:var(--wp--preset--spacing--sm);padding-left:var(--wp--preset--spacing--sm);font-weight:500;line-height:1.5"><?php echo esc_html(lawfirmpro_get_text('text_attorneys', 'Our experienced solicitors are committed to providing expert legal advice tailored to your individual needs. Get to know the team behind your success.')); ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
