 ...
 */
?>
<!-- wp:group {"className":"section-spacing-bottom","style":{"spacing":{"blockGap":"10px","padding":{"top":"40px"},"margin":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0"}},"border":{"top":{"color":"var:preset|color|accent-8","width":"1px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group section-spacing-bottom" style="border-top-color:var(--wp--preset--color--accent-8);border-top-width:1px;margin-top:var(--wp--preset--spacing--0);margin-bottom:var(--wp--preset--spacing--0);padding-top:40px"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
...
<h2 class="wp-block-heading has-text-align-center paragraph-padding"><?php echo esc_html(lawfirmpro_get_heading('heading_attorneys', 'Meet Our Experienced Attorneys')); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"paragraph-padding","style":{"layout":{"selfStretch":"fit","flexSize":null},"typography":{"textAlign":"center"},"elements":{"link":{"color":{"text":"var:preset|color|accent"}}}},"textColor":"accent"} -->
<p class="has-text-align-center paragraph-padding has-accent-color has-text-color has-link-color"><?php echo esc_html(lawfirmpro_get_text('text_attorneys', 'Our experienced solicitors are committed to providing expert legal advice tailored to your individual needs. Get to know the team behind your success.')); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"className":"custom-posts-grid attorney-posts-grid","style":{"spacing":{"margin":{"top":"var:preset|spacing|lg","bottom":"var:preset|spacing|lg"},"padding":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0","left":"var:preset|spacing|0","right":"var:preset|spacing|0"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group custom-posts-grid attorney-posts-grid" style="margin-top:var(--wp--preset--spacing--lg);margin-bottom:var(--wp--preset--spacing--lg);padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0)"><!-- wp:query {"queryId":78,"query":{"perPage":9,"pages":0,"offset":0,"postType":"attorney","order":"asc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[],"format":[]},"metadata":{"categories":["posts"],"patternName":"core/query-grid-posts","name":"Grid"}} -->
...
<div class="wp-block-group attorney-posts-group" style="margin-bottom:51px"><!-- wp:post-featured-image {"height":"193px","className":"attorneys-post-image"} /-->
