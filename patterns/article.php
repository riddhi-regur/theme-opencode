...
<div class="wp-block-group blogs-main"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
    ...
    <!-- wp:group {"className":"blog-heading-group","style":{"spacing":{"blockGap":"var:preset|spacing|sm"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center","verticalAlignment":"center"}} -->
    <div class="wp-block-group blog-heading-group"><!-- wp:heading {"textAlign":"center","className":"attorneys-heading","style":{"typography":{"fontWeight":"800","lineHeight":"1.1","fontSize":"clamp(32px, 5vw, 56px)"},"spacing":{"padding":{"right":"var:preset|spacing|sm","left":"var:preset|spacing|sm"}}}} -->
        <h2 class="wp-block-heading attorneys-heading" style="padding-right:var(--wp--preset--spacing--sm);padding-left:var(--wp--preset--spacing--sm);font-size:clamp(32px, 5vw, 56px);font-weight:800;line-height:1.1"><?php echo esc_html(lawfirmpro_get_heading('heading_articles', 'Your Guide to Understanding the Law')); ?></h2>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"className":"blogs-paragraph","style":{"typography":{"fontWeight":"500","lineHeight":"1.5","textAlign":"center"},"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"padding":{"right":"var:preset|spacing|sm","left":"var:preset|spacing|sm"}}},"fontFamily":"plus-jakarta-sans"} -->
        <p class="has-text-align-center blogs-paragraph has-plus-jakarta-sans-font-family" style="padding-right:var(--wp--preset--spacing--sm);padding-left:var(--wp--preset--spacing--sm);font-weight:500;line-height:1.5"><?php echo esc_html(lawfirmpro_get_text('text_articles', 'Stay informed with the latest legal insights, guides, and updates from our expert solicitors.')); ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
