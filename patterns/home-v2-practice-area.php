 ...
 */
?>
<!-- wp:group {"className":"section-spacing-top","style":{"spacing":{"blockGap":"10px","padding":{"top":"var:preset|spacing|xl","bottom":"var:preset|spacing|2xl"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group section-spacing-top" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--2xl)"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
    ...
    <div class="wp-block-group practice-area-heading-group"><!-- wp:heading {"textAlign":"center"} -->
        ...
        <p class="has-text-align-center practice-areas-paragraph" style="padding-right:20px;padding-left:20px"><?php echo esc_html(lawfirmpro_get_text('text_practice_sub_v2', 'Expert legal solutions tailored to protect your rights and secure your future. Our dedicated team provides comprehensive legal services across a wide range of practice areas.')); ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
