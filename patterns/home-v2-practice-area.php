 ...
 */
?>
<!-- wp:group {"className":"practice-areas-main","style":{"spacing":{"blockGap":"10px","padding":{"top":"68px","bottom":"77px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group practice-areas-main" style="padding-top:68px;padding-bottom:77px"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
