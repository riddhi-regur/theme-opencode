 ...
 */
?>
<!-- wp:group {"className":"attorneys-main","style":{"spacing":{"blockGap":"10px","margin":{"top":"var:preset|spacing|xl"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group attorneys-main" style="margin-top:var(--wp--preset--spacing--xl)"><!-- wp:buttons {"metadata":{"blockVisibility":{"viewport":{"desktop":false,"tablet":false,"mobile":false}}},"layout":{"type":"flex","justifyContent":"center"}} -->
    ...
    <div class="wp-block-group attorney-heading-group"><!-- wp:heading {"className":"attorneys-heading"} -->
        ...
        <p class="has-text-align-center attorneys-paragraph has-plus-jakarta-sans-font-family" style="padding-right:20px;padding-left:20px;font-weight:500">Our team brings together specialists across multiple areas of law, offering tailored legal solutions for individuals and businesses.</p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
