            ...
            <div class="wp-block-group service-detail-section1-group" style="margin-top:39px"><!-- wp:group {"style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
                <div class="wp-block-group"><!-- wp:image {"width":"20px","height":"20px","scale":"cover","sizeSlug":"full","linkDestination":"none","className":"team-detail-right-image","style":{"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"margin":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0","left":"var:preset|spacing|0","right":"var:preset|spacing|0"}}}} -->
                    ...
                    <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--0);margin-bottom:var(--wp--preset--spacing--0);padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0)">                        <!-- wp:heading {"textAlign":"center","className":"team-details-paragraph","style":{"typography":{"fontSize":"24px","fontWeight":"800","lineHeight":"1.3"}}} -->
                        ...
                        <p class="team-details-paragraph has-plus-jakarta-sans-font-family" style="margin-right:20px;line-height:1.5"><?php echo esc_html(lawfirmpro_get_text('text_sd_body', 'We pride ourselves on delivering practical, results-driven legal advice with a personal touch.')); ?></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>
...
<div class="wp-block-cover alignfull is-light service-detail-section2" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl)"><span aria-hidden="true" class="wp-block-cover__background has-accent-5-background-color has-background-dim-100 has-background-dim"></span>
    <div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
        <div class="wp-block-group">        <!-- wp:heading {"textAlign":"center","align":"wide","className":"service-detail-section2-heading","style":{"typography":{"fontWeight":"800","lineHeight":"1.1"},"spacing":{"padding":{"right":"20px","left":"20px"}}}} -->
            <h2 class="wp-block-heading alignwide service-detail-section2-heading" style="padding-right:20px;padding-left:20px;font-weight:800;line-height:1.1"><?php echo esc_html(lawfirmpro_get_heading('heading_sd_solutions', 'Funding Solutions For Growing Businesses')); ?></h2>
            <!-- /wp:heading -->
        </div>
        <!-- /wp:group -->
...
<div class="wp-block-group alignwide service-detail-section3" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl)"><!-- wp:group {"className":"service-detail-section3-stack","style":{"spacing":{"blockGap":"16px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
    <div class="wp-block-group service-detail-section3-stack">        <!-- wp:heading {"textAlign":"center","className":"service-detail-section3-heading","style":{"typography":{"fontWeight":"800","lineHeight":"1.1"},"spacing":{"padding":{"right":"20px","left":"20px"}}}} -->
        <h2 class="wp-block-heading service-detail-section3-heading" style="padding-right:20px;padding-left:20px;font-weight:800;line-height:1.1"><?php echo esc_html(lawfirmpro_get_heading('heading_sd_section3', 'Assets With &nbsp;Assurance Of Expert Guidance')); ?></h2>
        <!-- /wp:heading -->
