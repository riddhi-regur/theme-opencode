    ...
    <div class="wp-block-columns are-vertically-aligned-top" style="padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0)"><!-- wp:column {"verticalAlignment":"top","width":"px","style":{"spacing":{"padding":{"left":"var:preset|spacing|0","right":"var:preset|spacing|0","top":"var:preset|spacing|0","bottom":"var:preset|spacing|0"}}},"backgroundColor":"secondary"} -->
        <div class="wp-block-column is-vertically-aligned-top has-secondary-background-color has-background" style="padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0)"><!-- wp:group {"className":"service-detail-section1-stack","style":{"spacing":{"blockGap":"6px"}},"layout":{"type":"flex","orientation":"vertical"}} -->
            <div class="wp-block-group service-detail-section1-stack">                <!-- wp:heading {"textAlign":"center","className":"service-detail-section1-heading","style":{"typography":{"fontWeight":"800","lineHeight":"1.1"},"spacing":{"padding":{"right":"20px"}}}} -->
                <h2 class="wp-block-heading service-detail-section1-heading" style="padding-right:20px;font-weight:800;line-height:1.1"><?php echo esc_html(lawfirmpro_get_heading('heading_hero_v1', 'Lawyers Who Put You First')); ?></h2>
                <!-- /wp:heading -->
                ...
                <p class="service-detail-section1-paragraph has-plus-jakarta-sans-font-family" style="padding-right:var(--wp--preset--spacing--0);line-height:1.5">Our team brings together specialists across multiple areas of law, ensuring comprehensive legal support for every client.</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
            ...
            <div class="wp-block-group service-detail-section1-group" style="margin-top:39px"><!-- wp:group {"style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
                <div class="wp-block-group"><!-- wp:image {"width":"20px","height":"20px","scale":"cover","sizeSlug":"full","linkDestination":"none","className":"team-detail-right-image","style":{"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"margin":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0","left":"var:preset|spacing|0","right":"var:preset|spacing|0"}}}} -->
                    ...
                    <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--0);margin-bottom:var(--wp--preset--spacing--0);padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0)">                        <!-- wp:heading {"textAlign":"center","className":"team-details-paragraph","style":{"typography":{"fontSize":"24px","fontWeight":"800","lineHeight":"1.3"}}} -->
                        <h2 class="wp-block-heading team-details-paragraph" style="font-size:24px;font-weight:800;line-height:1.3">Tailored Funding Options</h2>
                        <!-- /wp:heading -->
                ...
                <div class="wp-block-group"><!-- wp:image {"width":"20px","height":"20px","scale":"cover","sizeSlug":"full","linkDestination":"none","className":"team-detail-right-image","style":{"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"margin":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0","left":"var:preset|spacing|0","right":"var:preset|spacing|0"}}}} -->
                    ...
                    <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0","left":"var:preset|spacing|0","right":"var:preset|spacing|0"},"margin":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0"},"blockGap":"8px"}},"layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
                    <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--0);margin-bottom:var(--wp--preset--spacing--0);padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0)">                        <!-- wp:heading {"textAlign":"center","className":"team-details-paragraph","style":{"typography":{"fontSize":"24px","fontWeight":"800","lineHeight":"1.3"}}} -->
                        <h2 class="wp-block-heading team-details-paragraph" style="font-size:24px;font-weight:800;line-height:1.3">Seamless Process</h2>
                        <!-- /wp:heading -->
                ...
                <div class="wp-block-group"><!-- wp:image {"width":"20px","height":"20px","scale":"cover","sizeSlug":"full","linkDestination":"none","className":"team-detail-right-image","style":{"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"margin":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0","left":"var:preset|spacing|0","right":"var:preset|spacing|0"}}}} -->
                    ...
                    <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0","left":"var:preset|spacing|0","right":"var:preset|spacing|0"},"margin":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0"},"blockGap":"8px"}},"layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
                    <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--0);margin-bottom:var(--wp--preset--spacing--0);padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0)">                        <!-- wp:heading {"textAlign":"center","className":"team-details-paragraph","style":{"typography":{"fontSize":"24px","fontWeight":"800","lineHeight":"1.3"}}} -->
                        <h2 class="wp-block-heading team-details-paragraph" style="font-size:24px;font-weight:800;line-height:1.3">Diversified Portfolio</h2>
                        <!-- /wp:heading -->
...
<div class="wp-block-group alignwide service-detail-section3" style="padding-top:64px;padding-bottom:64px"><!-- wp:group {"className":"service-detail-section3-stack","style":{"spacing":{"blockGap":"16px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
    <div class="wp-block-group service-detail-section3-stack">        <!-- wp:heading {"textAlign":"center","className":"service-detail-section3-heading","style":{"typography":{"fontWeight":"800","lineHeight":"1.1"},"spacing":{"padding":{"right":"20px","left":"20px"}}}} -->
        ...
        <!-- wp:paragraph {"className":"service-detail-section3-paragraph","style":{"typography":{"textAlign":"center","lineHeight":"1.5"},"spacing":{"padding":{"right":"20px","left":"20px"}}},"fontFamily":"plus-jakarta-sans"} -->
        <p class="has-text-align-center service-detail-section3-paragraph has-plus-jakarta-sans-font-family" style="padding-right:20px;padding-left:20px;line-height:1.5">Our solicitors bring decades of combined experience across a wide range of legal disciplines. We are committed to delivering practical, results-driven advice for individuals and businesses throughout England and Wales.</p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-columns service-detail-section3-columns"><!-- wp:column {"className":"service-detail-section3-column"} -->
        <div class="wp-block-column service-detail-section3-column"><!-- wp:group {"className":"service-detail-section3-columns-stack","style":{"spacing":{"padding":{"right":"8px","left":"30px","top":"50px","bottom":"34px"}},"border":{"width":"1px"}},"borderColor":"accent-8","layout":{"type":"flex","orientation":"vertical"}} -->
            <div class="wp-block-group service-detail-section3-columns-stack has-border-color has-accent-8-border-color" style="border-width:1px;padding-top:50px;padding-right:8px;padding-bottom:34px;padding-left:30px"><!-- wp:image {"sizeSlug":"full","linkDestination":"none","className":"service-detail-section3-icons"} -->
                ...
                <h2 class="wp-block-heading service-detail-section3-subtitle" style="font-size:32px;font-weight:800">Analysis Case</h2>
                <!-- /wp:heading -->

                <!-- wp:paragraph {"className":"service-detail-section3-paragraph","fontFamily":"plus-jakarta-sans"} -->
                <p class="service-detail-section3-paragraph has-plus-jakarta-sans-font-family">Our team brings together specialists across multiple areas of law, ensuring comprehensive legal support for every client.</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <div class="wp-block-column service-detail-section3-column"><!-- wp:group {"className":"service-detail-section3-columns-stack","style":{"spacing":{"padding":{"right":"8px","left":"30px","top":"50px","bottom":"34px"}},"border":{"width":"1px"}},"borderColor":"accent-8","layout":{"type":"flex","orientation":"vertical"}} -->
            <div class="wp-block-group service-detail-section3-columns-stack has-border-color has-accent-8-border-color" style="border-width:1px;padding-top:50px;padding-right:8px;padding-bottom:34px;padding-left:30px"><!-- wp:image {"sizeSlug":"full","linkDestination":"none","className":"service-detail-section3-icons"} -->
                ...
                <!-- wp:heading {"textAlign":"center","className":"service-detail-section3-subtitle","style":{"typography":{"fontSize":"32px","fontWeight":"800"}}} -->
                <h2 class="wp-block-heading service-detail-section3-subtitle" style="font-size:32px;font-weight:800">Information List</h2>
                <!-- /wp:heading -->
        ...
        <div class="wp-block-column service-detail-section3-column"><!-- wp:group {"className":"service-detail-section3-columns-stack","style":{"spacing":{"padding":{"right":"8px","left":"30px","top":"50px","bottom":"34px"}},"border":{"width":"1px"}},"borderColor":"accent-8","layout":{"type":"flex","orientation":"vertical"}} -->
            <div class="wp-block-group service-detail-section3-columns-stack has-border-color has-accent-8-border-color" style="border-width:1px;padding-top:50px;padding-right:8px;padding-bottom:34px;padding-left:30px"><!-- wp:image {"sizeSlug":"full","linkDestination":"none","className":"service-detail-section3-icons"} -->
                ...
                <!-- wp:heading {"textAlign":"center","className":"service-detail-section3-subtitle","style":{"typography":{"fontSize":"32px","fontWeight":"800"}}} -->
                <h2 class="wp-block-heading service-detail-section3-subtitle" style="font-size:32px;font-weight:800">Documentation</h2>
                <!-- /wp:heading -->
