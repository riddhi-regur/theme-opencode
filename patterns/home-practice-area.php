...
<div class="wp-block-group practice-areas-main has-secondary-color has-primary-background-color has-text-color has-background has-link-color" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--2xl)"><!-- wp:buttons {"metadata":{"blockVisibility":{"viewport":{"desktop":false,"tablet":false,"mobile":false}}},"layout":{"type":"flex","justifyContent":"center"}} -->
    ...
    <div class="wp-block-group practice-area-heading-group"><!-- wp:heading {"className":"wp-block-heading has-text-align-center practice-areas-heading has-secondary-color has-text-color"} -->
        <h2 class="wp-block-heading has-text-align-center practice-areas-heading has-secondary-color has-text-color"><?php echo esc_html(lawfirmpro_get_heading('heading_practice', 'Our Expertise Practice Areas')); ?></h2>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"className":"practice-areas-paragraph","style":{"typography":{"textAlign":"center"},"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"padding":{"right":"20px","left":"20px"}}},"textColor":"secondary"} -->
        <p class="has-text-align-center practice-areas-paragraph has-secondary-color has-text-color" style="padding-right:20px;padding-left:20px"><?php echo esc_html(lawfirmpro_get_text('text_practice_sub', 'Expert legal solutions tailored to protect your rights, interests, and future with confidence.')); ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-group custom-posts-grid practice-area-posts-grid custom-post-slider" style="margin-top:var(--wp--preset--spacing--md);margin-bottom:60px;padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0)"><!-- wp:query {"queryId":78,"query":{"perPage":100,"pages":0,"offset":0,"postType":"practice-area","order":"asc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[],"format":[]},"metadata":{"categories":["posts"],"patternName":"core/query-grid-posts","name":"Grid"}} -->
        <div class="wp-block-query"><!-- wp:post-template {"style":{"spacing":{"blockGap":"21px"}},"layout":{"type":"grid","columnCount":3}} -->
            <!-- wp:group {"className":"practice-area-posts-group","style":{"spacing":{"blockGap":"20px"}},"backgroundColor":"accent-4","layout":{"inherit":false}} -->
            <div class="wp-block-group practice-area-posts-group has-accent-4-background-color has-background"><!-- wp:post-featured-image {"height":"270px","className":"homepage-practice-areas-post-image "} /-->
                ...
                <div class="wp-block-group practice-area-data-group" style="padding-right:21px;padding-left:21px"><!-- wp:post-title {"textAlign":"left","isLink":true,"className":"practice-areas-post-tile","style":{"typography":{"fontStyle":"normal","fontWeight":"700","letterSpacing":"0%","lineHeight":"1.3","fontSize":"24px"}},"fontFamily":"plus-jakarta-sans"} /-->
                    ...
                    <!-- wp:post-excerpt {"textAlign":"left","showMoreOnNewLine":false,"excerptLength":46,"className":"practice-areas-post-paragraph","style":{"color":{"text":"var:preset|color|secondary"},"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"400","letterSpacing":"0%","lineHeight":"1.5"},"spacing":{"padding":{"right":"10px"}}},"textColor":"secondary","fontFamily":"plus-jakarta-sans"} /-->
    ...
    <div class="wp-block-buttons" style="margin-top:60px"><!-- wp:button {"backgroundColor":"secondary","textColor":"primary","className":"is-style-fill","style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"800","textTransform":"uppercase"},"spacing":{"padding":{"left":"35px","right":"35px","top":"14px","bottom":"14px"}}},"fontFamily":"plus-jakarta-sans"} -->
        ...
        <div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-secondary-color has-primary-background-color has-text-color has-background has-link-color has-plus-jakarta-sans-font-family has-custom-font-size wp-element-button" href="<?php echo esc_url(lawfirmpro_get_page_url('contact_page_id', '/contact/')); ?>" style="padding-right:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--lg);font-size:16px;font-style:normal;font-weight:800;text-transform:uppercase"><?php echo esc_html(lawfirmpro_get_label('btn_request_quote', 'Request a Quote')); ?> ➔</a></div>
        <!-- /wp:button -->
    </div>
    <!-- /wp:buttons -->
</div>
