...
/**
 * Title: Attorney CTA Button 1
 * Categories: lawfirmpro
 * Keywords: attorney, button, cta
 */
?>
<!-- wp:buttons {"metadata":{"blockVisibility":{"viewport":{"desktop":false,"tablet":false,"mobile":false}}},"className":"attorney-btn","style":{"spacing":{"blockGap":{"left":"8px"}}},"layout":{"type":"flex","justifyContent":"center"}} -->
