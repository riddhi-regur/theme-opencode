 ...
 */
?>
<!-- wp:group {"className":"protect-rights-main","style":{"spacing":{"margin":{"top":"64px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group protect-rights-main" style="margin-top:64px"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
    ...
    <div class="wp-block-group protect-rights-heading-group"><!-- wp:heading {"className":"protect-rights-heading","style":{"typography":{"fontWeight":"800","lineHeight":"1.1","fontSize":"56px"},"spacing":{"padding":{"right":"20px","left":"20px"}}}} -->
        <h2 class="wp-block-heading protect-rights-heading" style="padding-right:20px;padding-left:20px;font-size:56px;font-weight:800;line-height:1.1">Protecting Your Rights With&nbsp;Dedication</h2>
        <!-- /wp:heading -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center"} -->
        <div class="wp-block-column is-vertically-aligned-center"><!-- wp:paragraph {"className":"article-title","style":{"typography":{"fontWeight":"500"}},"fontFamily":"plus-jakarta-sans"} -->
            <p class="article-title has-text-color has-plus-jakarta-sans-font-family" style="font-weight:500">With over 25 years of experience, <?php bloginfo('name'); ?> has been a trusted partner for individuals and businesses across England and Wales. Our team of expert solicitors provides tailored legal solutions with a personal touch.</p>
            <!-- /wp:paragraph -->

            <!-- wp:paragraph {"className":"article-title","style":{"typography":{"fontWeight":"500"}},"fontFamily":"plus-jakarta-sans"} -->
            <p class="article-title has-text-color has-plus-jakarta-sans-font-family" style="font-weight:500">From conveyancing and family law to personal injury and commercial disputes, we combine deep expertise with genuine care for our clients. Your legal matters are handled with precision, confidentiality, and dedication.</p>
            <!-- /wp:paragraph -->
            ...
            <div class="wp-block-buttons"><!-- wp:button {"style":{"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"800","textTransform":"uppercase"}},"fontFamily":"plus-jakarta-sans"} -->
                <div class="wp-block-button"><a class="wp-block-button__link has-plus-jakarta-sans-font-family has-custom-font-size wp-element-button" href="<?php echo esc_url(lawfirmpro_get_page_url('about_page_id', '/about/')); ?>" style="font-size:16px;font-style:normal;font-weight:800;text-transform:uppercase">Learn More 🡲</a></div>
                <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
        </div>
        ...
        <div class="wp-block-column is-vertically-aligned-top"><!-- wp:cover {"url":"<?php echo esc_url(get_theme_file_uri('assets/images/justice.png')); ?>","dimRatio":0,"overlayColor":"secondary","isUserOverlayColor":true,"minHeight":300,"contentPosition":"bottom center","isDark":false,"sizeSlug":"full","align":"center","className":"protect-rights-cover","style":{"spacing":{"padding":{"top":"var:preset|spacing|0","bottom":"var:preset|spacing|0","left":"var:preset|spacing|0","right":"var:preset|spacing|0"},"blockGap":"var:preset|spacing|0"}},"layout":{"type":"default"}} -->
            <div class="wp-block-cover aligncenter is-light has-custom-content-position is-position-bottom-center protect-rights-cover" style="padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0);min-height:300px"><img class="wp-block-cover__image-background wp-image-651 size-full" alt="" src="<?php echo esc_url(get_theme_file_uri('assets/images/justice.png')); ?>" data-object-fit="cover" /><span aria-hidden="true" class="wp-block-cover__background has-secondary-background-color has-background-dim-0 has-background-dim"></span>
                <div class="wp-block-cover__inner-container"><!-- wp:image {"width":"406px","height":"542px","scale":"cover","sizeSlug":"full","linkDestination":"none","align":"center","className":"protect-rights-img"} -->
                    <figure class="wp-block-image aligncenter size-full is-resized protect-rights-img"><img src="<?php echo esc_url(get_theme_file_uri('assets/images/justice-man.png')); ?>" alt="" class="wp-image-652" style="object-fit:cover;width:406px;height:542px" /></figure>
                    <!-- /wp:image -->
                </div>
            </div>
            <!-- /wp:cover -->
