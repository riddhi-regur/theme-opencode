 ...
 */
?>
<!-- wp:group {"className":"section-spacing-top","layout":{"type":"default"}} -->
<div class="wp-block-group section-spacing-top"><!-- wp:cover {"url":"<?php echo esc_url(get_theme_file_uri('assets/images/contact-form.png')); ?>","dimRatio":0,"customOverlayColor":"#544a46","isUserOverlayColor":false,"minHeight":400,"sizeSlug":"large","layout":{"type":"constrained"}} -->
<div class="wp-block-cover" style="min-height:400px"><img class="wp-block-cover__image-background size-large" alt="" src="<?php echo esc_url(get_theme_file_uri('assets/images/contact-form.png')); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#544a46"></span><div class="wp-block-cover__inner-container"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|0","left":"var:preset|spacing|0"}}}} -->
...
<h2 class="wp-block-heading contact-form-heading" style="line-height:1.1"><?php echo esc_html(lawfirmpro_get_heading('heading_consultation', 'Get In Touch')); ?></h2>
<!-- /wp:heading -->
